...
(defun    (right-padded-word-extraction---second-limb-padded)           (- 1 (next prprc/WCP_RES)))
...
(defun    (right-padded-word-extraction---first-limb-is-full)           (shift prprc/EUC_QUOT 2))
