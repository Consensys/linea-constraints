...
(defun    (any-to-ram-with-padding---some-data---only-dt-single-target)             (- 1 (shift prprc/EUC_QUOT 7)))
(defun    (any-to-ram-with-padding---some-data---only-dt-maxes-out-target)          (shift prprc/WCP_RES 7))
(defun    (any-to-ram-with-padding---some-data---first-dt-single-target)            (- 1 (shift prprc/EUC_QUOT 8)))
