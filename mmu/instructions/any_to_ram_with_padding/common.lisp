...
(defun    (any-to-ram-with-padding---pure-padd)                  (- 1 (next prprc/WCP_RES)))
...
(defun    (any-to-ram-with-padding---mixed)                      (* (- 1 (any-to-ram-with-padding---pure-padd))
                                                                                (- 1 (shift prprc/WCP_RES 2))))
(defun    (any-to-ram-with-padding---pure-data)                  (* (- 1 (any-to-ram-with-padding---pure-padd)) (shift prprc/WCP_RES 2)))
