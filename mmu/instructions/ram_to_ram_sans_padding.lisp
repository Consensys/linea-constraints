...
(defun    (ram-to-ram-sans-padding---last-limb-is-full)             (shift prprc/EUC_QUOT 5))
(defun    (ram-to-ram-sans-padding---first-limb-is-fast)            (* (ram-to-ram-sans-padding---aligned) (ram-to-ram-sans-padding---init-tbo-is-zero))) ;;""
...
(defconstraint    ram-to-ram-sans-padding---mmio-instruction-writting (:guard IS_RAM_TO_RAM_SANS_PADDING)
                  (begin (if-eq (+ NT_FIRST NT_MDDL) 1
