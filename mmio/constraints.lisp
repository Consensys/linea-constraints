...
(defun (weighted-exo-sum)
  (+ (* (^ 2 EXO_SUM_ROM) EXO_IS_ROM)
     (* (^ 2 EXO_SUM_KEC) EXO_IS_KEC)
     (* (^ 2 EXO_SUM_LOG) EXO_IS_LOG)
     (* (^ 2 EXO_SUM_TXCD) EXO_IS_TXCD)
     (* (^ 2 EXO_SUM_ECDATA) EXO_IS_ECDATA)
     (* (^ 2 EXO_SUM_RIPSHA) EXO_IS_RIPSHA)
     (* (^ 2 EXO_SUM_BLAKEMODEXP) EXO_IS_BLAKEMODEXP)))
