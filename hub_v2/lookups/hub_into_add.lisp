(defun (add-activation-flag)
  (and (unexceptional-stack-row)
       hub_v2.stack/ADD_FLAG))


(deflookup hub-into-add
    ;; target columns
    (
        add.ARG_1_HI
        add.ARG_1_LO
    ...
    (
        ...
        (* [hub_v2.stack/STACK_ITEM_VALUE_HI 3]     (add-activation-flag))   ;; arg2
        (* [hub_v2.stack/STACK_ITEM_VALUE_LO 3]     (add-activation-flag))
