...
(defconstraint    tx-skip---SYSI-2935---storing-the-previous-block-hash-in-state
                  ...
                  (begin
                    ...
                    (eq!   (shift   storage/STORAGE_VALUE_NEXT_HI   tx-skip---SYSI-2935---row-offset---STO---storing-the-time-stamp)   (tx-skip---SYSI-2935---prev-block-hash-hi))
                    (eq!   (shift   storage/STORAGE_VALUE_NEXT_LO   tx-skip---SYSI-2935---row-offset---STO---storing-the-time-stamp)   (tx-skip---SYSI-2935---prev-block-hash-lo))
