...
(defconstraint   tx-init---account-row---recipient-value-reception
                 ...
                 (begin
                   ...
                   (account-same-warmth                           tx-init---row-offset---ACC---recipient-value-reception)
...
(defcontraint    tx-init---account-row---recipient-value-reception---message-call
                 (:guard (tx-init---standard-precondition))
                 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
(defcontraint    tx-init---account-row---recipient-value-reception---deployment---nonce
                 (:guard (tx-init---standard-precondition))
                 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
(defcontraint    tx-init---account-row---recipient-value-reception---deployment---code
                 (:guard (tx-init---standard-precondition))
                 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                 (if-not-zero   (tx-init---is-deployment)
                                (begin
...
(defcontraint    tx-init---account-row---recipient-value-reception---deployment---deployment-number-and-status
                 (:guard (tx-init---standard-precondition))
                 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                 (if-not-zero   (tx-init---is-deployment)
                                (begin
