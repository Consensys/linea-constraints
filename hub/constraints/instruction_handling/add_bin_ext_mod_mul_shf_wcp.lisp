...
(defun (classifier-stateless-instructions) (+ stack/ADD_FLAG
                                              ...
                                              stack/SHF_FLAG
                                              stack/WCP_FLAG ))
(defun (stateless-instruction-is-exp)   (* stack/MUL_FLAG (nth stack/DEC_FLAG 2)))
(defun (stateless-instruction-isnt-exp) (+ stack/ADD_FLAG
                                           ...
                                           stack/SHF_FLAG
                                           stack/WCP_FLAG 
                                           (* stack/MUL_FLAG (nth stack/DEC_FLAG 1))))
(defun (one-arg-stateless-instruction) (* (+ stack/BIN_FLAG stack/WCP_FLAG)
                                          (nth stack/DEC_FLAG 1)))
(defun (two-arg-stateless-instruction) (+ stack/ADD_FLAG 
                                          (* stack/BIN_FLAG (- 1 (nth stack/DEC_FLAG 1)))
                                          stack/MOD_FLAG
                                          stack/MUL_FLAG
                                          stack/SHF_FLAG
                                          (* stack/WCP_FLAG (- 1 (nth stack/DEC_FLAG 1)))))
...
(defconstraint add-bin-ext-mod-mul-shf-wcp-safeguard (:guard PEEK_AT_STACK)
               (begin
                 (eq! (classifier-stateless-instruction)
                      (+ (stateless-instruction-is-exp)
                         (classifier-stateless-instruction-isnt-exp)))
                 (eq!((classifier-stateless-instruction)
