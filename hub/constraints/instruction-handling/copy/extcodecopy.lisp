...
(defconstraint copy-setting-the-gas-cost-for-EXTCODECOPY (:guard (copy-instruction---standard-EXTCODECOPY))
...
(defconstraint copy-the-MXPX-case-for-EXTCODECOPY (:guard (copy-instruction---standard-EXTCODECOPY))
               (if-not-zero stack/MXPX
                            (execution-provides-empty-return-data ROW_OFFSET_EXTCODECOPY_MXPX_CONTEXT_ROW)))

(defconstraint copy-the-OOGX-case-for-EXTCODECOPY (:guard (copy-instruction---standard-EXTCODECOPY))
               (if-not-zero stack/OOGX
                            ;; account-row i + 2
                            (begin (account-trim-address ROW_OFFSET_EXTCODECOPY_OOGX_ACCOUNT_ROW
                                                         (copy-instruction---raw-address-hi)
                                                         (copy-instruction---raw-address-lo))
