...
(defun    (precompile-scenario-row-setting    relative_row_offset)
  (begin
    ...
    (eq!    (shift    scenario/PRC_SUCCESS_WILL_REVERT                     relative_row_offset)    scenario/CALL_PRC_SUCCESS_CALLER_WILL_REVERT)
    (eq!    (shift    scenario/PRC_SUCCESS_WONT_REVERT                     relative_row_offset)    scenario/CALL_PRC_SUCCESS_CALLER_WONT_REVERT)
