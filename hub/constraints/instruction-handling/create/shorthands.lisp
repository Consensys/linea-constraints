...
(defun    (create-instruction---RLPADDR-keccak-hi)            (shift   stack/HASH_INFO_KECCAK_HI         CREATE_first_stack_row___row_offset))
(defun    (create-instruction---RLPADDR-keccak-lo)            (shift   stack/HASH_INFO_KECCAK_LO         CREATE_first_stack_row___row_offset))
