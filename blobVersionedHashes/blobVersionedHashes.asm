;; BLOB_VERSIONED_HASHES module

;; The BLOB_VERSIONED_HASHES is responsible for storing blob versioned hashes from BLOB transactions. It contains:
...
pub fn blobVersionedHashes(USER_TXN_NUMBER u24, TOT_NUMBER_OF_HASHES u16, HASH_INDEX u256, BLOB_VERSION_HASH u256) -> (OOI=0x01 u1) {
