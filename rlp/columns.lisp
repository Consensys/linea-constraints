...
(defcolumns
  ...
  (addr_lo_ndl :binary@bool)         ;; indicates whether addr_lo_1 (= 0) or addr_lo_2 (= 1) is being built

  tn                         ;; line-wise bit decomposition of NONCE least significant byte
  (in-nonce :binary@bool)           ;; set to 1 if the first non-null byte of the nonce has been found
