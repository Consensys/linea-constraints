...
(defconstraint access-list---setting-flag-after-storage-list-list-rlp ()
    (if-not-zero IS_PREFIX_OF_STORAGE_KEY_LIST
        (begin 
        (eq! (+ (next IS_PREFIX_OF_STORAGE_KEY_LIST) (next IS_ACCESS_LIST_STORAGE_KEY) (next IS_PREFIX_OF_ACCESS_LIST_ITEM))       (next IS_ACCESS_LIST))
...
(defconstraint access-list---setting-flag-after-storage-key ()
    (if-not-zero IS_ACCESS_LIST_STORAGE_KEY
        (begin 
        (eq! (+ (next IS_ACCESS_LIST_STORAGE_KEY) (next IS_PREFIX_OF_ACCESS_LIST_ITEM))                       (next IS_ACCESS_LIST))
