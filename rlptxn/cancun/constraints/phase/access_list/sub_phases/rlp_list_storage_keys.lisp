...
(defconstraint setting-rlp-access-list--item-rlp-prefix ()
    (if-not-zero (* IS_PREFIX_OF_STORAGE_KEY_LIST (prev DONE))
        (begin
        (rlp-compound-byte-string-non-trivial  0 (length-of-concatenated-storage-keys-rlp) 1 0)
...
(defun (length-of-concatenated-storage-keys-rlp)            (* 33 (storage-key-list-countdown)))
